...
const PublicAssetsTable = (props: any) => {
    const { folderStructureList } = props;
        ...
        <div className="px-4 sm:px-2 lg:px-4 py-4">
            <div className="sm:flex sm:items-center my-2">
                ...
                <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    ...
                    >
                        <button type="button" className="flex text-gray-600 rounded-md px-3 py-2 bg-gray-300 text-center text-sm font-semibold shadow-xl hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                        ...
                                        return (
                                            <>
                                                <tr className="border-t border-gray-200">
                                                    <th colSpan={5} scope="colgroup" className="bg-gray-50 py-2 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3">{`User ${i+1} shared`}</th>
                                                </tr>
