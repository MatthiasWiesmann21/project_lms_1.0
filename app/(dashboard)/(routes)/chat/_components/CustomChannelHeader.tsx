import { ChannelHeader, ChannelHeaderProps, useChannelActionContext, useChannelStateContext } from "stream-chat-react";
...
function ChannelNotificationToggleButton({user, channelId}: ChannelNotificationToggleButtonProps) {
